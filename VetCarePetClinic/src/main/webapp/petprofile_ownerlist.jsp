      ...
      <!-- ownerlist  starts from here -->
       ...
       <div class="container">
         ...
         <div class="container" style="background-color:#ffffff;">
            <br/>
            <br/> 
            <h3 class="text-body" style="text-align:center;">Pet Owners </h3>
             <br/>
             <br/>  
             ...
             <div class="container">
               <div class="row">
                  ...
                  <div class="col-sm">
                      <div class=search>
		                <form action="petownersearch" name="frm" method="post">
		                   <table align="center">
			                 <tr>
			                   <td colspan=2 style="font-size:12pt;" align="center">
			                     <td><input type="text" class="form-control" id="myInput" name="name" placeholder="Search Name" ></td>
                  ...
                  <div class="col-sm">
                       <a href="petprofile_addowner.jsp">
                          <center><button type="button" class="btn btn-success">Add New Owner</button></center>
                       </a>
                  </div>
                 <div class="col-sm">
           ...
           <div class="container">     
             <table class="table table-striped" id="myTable">
                ...
                <tr>
                  ...
                  <td><a href="petprofile_update_petowner.jsp?id=<%=resultSet.getString("ownerID")%>"><button type="button" class="btn btn-info">
                  Update</button></a></td>
                  <td><a href="petprofile_delete_petowner.jsp?id=<%=resultSet.getString("ownerID")%>"><button type="button" class="btn btn-danger">
                  Delete</button></a></td>
