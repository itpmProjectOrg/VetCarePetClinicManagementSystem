    ...
    <!-- pet insert  starts from here -->
         ...
         <div class="container" style="background-color:#ffffff; width:50%">
            ...
            <br> 
             ...
             <h3 class="text-body" style="text-align:center;">Inserted Successfully! </h3>
                  <br/>
                  <br/>
               <div class="container">
                <div class="row">
                  ...
                  <div class="col">
                       <center> 
                      <a href="petprofile_addowner.jsp"><button type="button" class="btn btn-outline-success" style="width:200px;">Add Another Owner</button></a>
                      <br/>
                      <br/>
                       <a href="petprofile_ownerlist.jsp"><button type="button" class="btn btn-outline-success" style="width:200px;">Back To Owners List</button>
                      </a>
                        <br/>
                      <br/>
