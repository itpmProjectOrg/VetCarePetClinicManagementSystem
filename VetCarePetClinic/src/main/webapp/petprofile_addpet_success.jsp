             ...
             <h3 class="text-body" style="text-align:center;">Inserted Successfully! </h3>
               ...
               <div class="container">
                <div class="row">
                  ...
                  <div class="col">
                       <center> 
                      <a href="petprofile_addpet.jsp"><button type="button" class="btn btn-outline-success" style="width:200px;">Add Another Pet</button></a>
                      <br/>
                      <br/>
                       <a href="petprofile_petlist.jsp"><button type="button" class="btn btn-outline-success" style="width:200px;">Back To Pets List</button>
                      </a>
                        <br/>
                      <br/>
