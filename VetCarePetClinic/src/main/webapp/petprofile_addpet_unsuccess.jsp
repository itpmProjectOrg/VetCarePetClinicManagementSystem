    ...
    <!-- pet insert  starts from here -->
         ...
         <div class="container" style="background-color:#ffffff; width:50%">
            ...
            <br> 
             ...
             <h3 class="text-body" style="text-align:center;">Inserted Unsuccessfully! </h3>
                  <br/>
                  <br/>
               <div class="container">
                <div class="row">
                  ...
                  <div class="col">
                       <center> 
                      <a href="petprofile_addpet.jsp"><button type="button" class="btn btn-outline-success" style="width:200px;">Add Again</button></a>
                      <br/>
                      <br/>
